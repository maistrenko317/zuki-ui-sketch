...
public class Subscriber implements Serializable
{
    ...
    public Subscriber(long _subscriberId, String _nickname) {
        this._subscriberId = _subscriberId;
        this._nickname = _nickname;
    }

    public Subscriber(long _subscriberId, String _nickname, Date createDate, Long _mintParentSubscriberId) {
        this._subscriberId = _subscriberId;
        this._nickname = _nickname;
        this._createDate = createDate;
        this._mintParentSubscriberId = _mintParentSubscriberId;
    }
        
    public Subscriber(long _subscriberId, String _nickname, Date createDate, Long _mintParentSubscriberId, String photoUrl) {
        this._subscriberId = _subscriberId;
        this._nickname = _nickname;
        this._createDate = createDate;
        this._mintParentSubscriberId = _mintParentSubscriberId;

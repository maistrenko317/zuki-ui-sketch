...
export class Particle {
  ...
  constructor(
    ...
    this.hue = randomFloat(hue - PARTICLE_HUE_VARIANCE, hue + PARTICLE_HUE_VARIANCE);
    // Set brightness.
    this.brightness = randomFloat(PARTICLE_BRIGHTNESS_MIN, PARTICLE_BRIGHTNESS_MAX);
    // Set decay.
    this.decay = randomFloat(PARTICLE_DECAY_MIN, PARTICLE_DECAY_MAX);
    // Set speed.
    this.speed = randomFloat(PARTICLE_SPEED_MIN, PARTICLE_SPEED_MAX);
